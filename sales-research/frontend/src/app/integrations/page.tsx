...
const INTEGRATIONS: IntegrationMetadata[] = [
  ...
  },
  {
    id: "slack",
    name: "Slack",
    description: "Send alerts and interactive research pulses to your team.",
    icon: Slack,
...
export default function IntegrationsPage() {
  ...
  const handleSaveKitKey = async (key: string, isSecret = false) => {
    ...
    try {
      ...
      toast({
        title: "Success",
        description: `${isSecret ? "Secret" : "Public"} Key saved.`,
      });
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {INTEGRATIONS.map((app) => {
            ...
            return (
              <Card
                key={app.id}
                className="relative overflow-hidden group border-2 transition-all hover:border-primary/50"
              >
                      ...
                      <div className="space-y-3 bg-muted/30 p-4 rounded-xl border border-border/50">
                        <div className="flex items-center justify-between">
                          ...
                          {settings?.kit_api_key && (
                            <Badge
                              variant="outline"
                              className="text-[9px] h-4 bg-green-500/10 text-green-500 border-green-500/20 px-1.5"
                            >
                              Connected
                            </Badge>
                          )}
                        ...
                        <div className="space-y-3">
                          ...
                          <Input
                            ...
                            onBlur={(e) =>
                              handleSaveKitKey(e.target.value, false)
                            }
                          />
                        </div>
                        <div className="space-y-1.5 pt-2">
                          ...
                          <Input
                            ...
                            onBlur={(e) =>
                              handleSaveKitKey(e.target.value, true)
                            }
                          />
                          <p className="text-[10px] text-muted-foreground">
                            Public Key is for listing forms. Secret Key is for
                            tracking activity.
                          </p>
                        </div>
                      </div>
                        ...
                        <div className="space-y-4">
                            ...
                            {isLoadingForms && kitForms.length === 0 ? (
                              ...
                              kitForms.slice(0, 10).map((form) => (
                                ...
                                >
                                  <div className="flex items-center justify-between mb-1">
                                    ...
                                    <Badge
                                      variant="outline"
                                      className="text-[9px] h-4 bg-primary/5 text-primary border-primary/20 hover:bg-primary/10 transition-colors"
                                    >
                                      {form.type}
                                    </Badge>
                                  </div>
                              ...
                              <div className="flex flex-col items-center justify-center py-6 space-y-2 bg-muted/10 rounded-xl border border-dashed">
                                <p className="text-[10px] text-muted-foreground italic text-balance text-center px-4">
                                  No active forms found. Make sure you have
                                  created forms in your Kit account.
                                </p>
                              </div>
                            )}
                          </div>
                          ...
                          {kitForms.length > 5 && (
                            <p className="text-[9px] text-muted-foreground text-center italic">
                              Showing {Math.min(kitForms.length, 10)} of{" "}
                              {kitForms.length} forms
                            </p>
                          )}
                        </div>
                      )}
                            ...
                            <Input
                              ...
                              onBlur={(e) => {
                                if (settings) {
                                  const updated = {
                                    ...settings,
                                    hubspot_access_token: e.target.value,
                                  };
                                  saveIntegrations(updated).then(() => {
                                    ...
                                    toast({
                                      ...
                                      description:
                                        "HubSpot access token has been saved.",
                                    });
                                  });
                                }
                              }}
                      ...
                      <div className="space-y-3 bg-muted/30 p-4 rounded-xl border border-border/50">
                        ...
                        <div className="space-y-3 pt-1">
                          <div className="space-y-2">
                                ...
                                if (settings) {
                                  ...
                                  saveIntegrations(updated).then(() => {
                                    ...
                                    toast({
                                      title: "Configuration Updated",
                                      description:
                                        "Slack webhook URL has been saved.",
                                    });
                                  });
                                }
                              }}
                            />
                            <p className="text-[10px] text-muted-foreground leading-tight">
                              Found in your Slack App settings under "Incoming
                              Webhooks".
                            </p>
                          </div>
                          ...
                          <div className="pt-2 border-t border-border/20">
                            ...
                            <p className="text-[10px] text-muted-foreground leading-tight mb-2">
                              Paste this into your Slack App "Interactivity &
                              Shortcuts" settings.
                            </p>
                            <div className="flex gap-2">
                              <Input
                                readOnly
                                value={webhookUrl}
                                className="bg-muted text-[10px] h-8 font-mono"
                              />
                              <Button
                                size="icon"
                                variant="ghost"
        ...
        <Card className="bg-primary/5 border-primary/20">
          ...
          <CardContent>
            <p className="text-sm text-balance leading-relaxed">
              Most integrations listed here work by sending research data to our
              AI engine. Ensure your external forms have at least an{" "}
              <strong>email</strong> or <strong>linkedin_url</strong> field to
              trigger the analysis. Extra fields like "Job Title" or "Use Case"
              will automatically be detected and used to improve the
